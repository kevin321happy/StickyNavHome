...
public class PageGridView extends RecyclerView {
    private int mRows = 0;//行数,如果为0表示横向显示gridview
    private int mColums = 0;//列数,如果为0表示纵向的gridView
    private int mPageSize = 0;//页数
    private int mOnePageSize = 0;//每一页显示的条目的个数
    ...
    public PageGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mRows > 0) {
            ...
            //设置StaggeredGridLayoutManager的布局管理器
